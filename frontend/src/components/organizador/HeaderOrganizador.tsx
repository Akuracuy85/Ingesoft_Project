  ...
  return (
    <header className="h-16 bg-card border-b border-border flex items-center justify-between px-8">
      ...
      <div className="flex items-center gap-2">
        ...
        <Link to="/eventos" className="ml-4 px-3 py-2 rounded-md font-medium text-sm bg-[#F6BA26] hover:bg-[#C37723] dark:bg-[#F6BA26] dark:hover:bg-[#C37723] text-white dark:text-gray-900 transition">
          Ver eventos
        </Link>
      </div>
