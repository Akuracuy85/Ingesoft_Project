      ...
      <div className="fixed inset-0 bg-black/30 dark:bg-black/40 backdrop-blur-sm z-50 flex items-start justify-center" onClick={onClose}>
        <div className="mx-auto my-10 bg-white dark:bg-card dark:text-card-foreground rounded-lg shadow-lg p-6 w-full max-w-md" onClick={(e) => e.stopPropagation()}>
          <div className="flex items-start justify-between mb-4">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Crear artista</h3>
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                <select
                  ...
                  onChange={onChange}
                  className={`flex-1 border rounded-md px-3 py-2 text-sm bg-white dark:bg-card dark:text-card-foreground dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-amber-500 ${categoriaError ? "border-red-500" : "border-gray-300 dark:border-border"}`}
                >
